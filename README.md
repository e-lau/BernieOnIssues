...
3. Add social media accounts and add e-mail to formspree form

4. Add HTTPS

5. Be able to easily add summaries of sub-issues in the front matter of the issue page (just filler text at the moment)
